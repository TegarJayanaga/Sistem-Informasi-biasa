    ...
    <div class="container">
        <div class="row">
            <div class="col text-center">
                <h3 class="my-3">Data Peminjaman Buku Perpustakaan</h3>
                    ...
                    <tbody>
                        ...
                        <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                            <tr>
                                ...
                                <td><a href="edit1.php?id=<?php echo $row['id_peminjam']; ?>"><button type="button" class="btn btn-warning">Edit</button></a>
                                    <a href="hapus.php?id=<?php echo $row['id_peminjam']; ?>"><button type="button" class="btn btn-primary">Selesai</button></a>
                                </td>
                            </tr>
                        <?php } ?>
                        </tr>
                ...
                <div class="btn-group" role="group" aria-label="Basic example">
                    <a href="tambahdata2.php" class="btn btn-primary btn-lg">Tambah Data</a>
                </div>
            </div>
        </div>
    </div>
