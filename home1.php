    ...
    <div class="container">
        <div class="row">
            <div class="col text-center">
                <h3 class="my-3">Data Buku Perpustakaan</h3>
                    ...
                    <tbody>
                        ...
                        <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                            <tr>
                                ...
                                <td><a href="edit2.php?id=<?php echo $row['id_buku']; ?>"><button type="button" class="btn btn-warning">Edit</button></a>
                                    <a href="hapus1.php?id=<?php echo $row['id_buku']; ?>"><button type="button" class="btn btn-danger">Hapus</button></a>
                                </td>
                            </tr>
                        <?php } ?>
                        </tr>
